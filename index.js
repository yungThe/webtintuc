...
// apis 
const API_KEY = "907eeae7ba0f4f3ea6f22fb7eb7716f8";
...
const TECHNOLOGY_NEWS = "https://newsapi.org/v2/top-headlines?country=us&cacaategory=technology&pageSize=8&apiKey=";
...
generalBtn.addEventListener("click",function(){
    newsType.innerHTML="<h4>Mới</h4>";
    fetchGeneralNews();
});

businessBtn.addEventListener("click",function(){
    newsType.innerHTML="<h4>Tài chính</h4>";
    fetchBusinessNews();
});
...
searchBtn.addEventListener("click",function(){
    newsType.innerHTML="<h4>Tìm kiếm : "+newsQuery.value+"</h4>";
    fetchQueryNews();
});
...
const fetchHeadlines = async () => {
    ...
    if(response.status >=200 && response.status < 300) {
        ...
        newsdetails.innerHTML = "<h5>Thử từ khoá khác</h5>"
        return;
    }
